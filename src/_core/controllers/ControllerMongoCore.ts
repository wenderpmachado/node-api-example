...
import { RepositoryMongoCore } from '../repositories/RepositoryMongoCore';

export class ControllerMongo implements Controller {
    constructor(private facade: RepositoryMongoCore) {
        this.facade = facade;
    }
